...
public class StressFactorFactory {
	...
	public StressFactor createStressFactor (String type, double[] thetaWp, double[] thetaFc, int[] ID, double[] z, double[] deltaZ, int NUM_CONTROL_VOLUMES, double totalDepth) {

		StressFactor stressFactor = null;
		if(type.equalsIgnoreCase("LinearStressFactor") || type.equalsIgnoreCase("LinearStressFactor")){
			stressFactor = new LinearStressFactor(thetaWp, thetaFc, ID, z, deltaZ, NUM_CONTROL_VOLUMES, totalDepth);}
		return stressFactor;
	}
