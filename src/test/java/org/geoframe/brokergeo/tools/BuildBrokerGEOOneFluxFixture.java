...
/**
 * Generator for the {@code BrokerGEOOneFlux.gpkg} fixture.
 */
public class BuildBrokerGEOOneFluxFixture {

	public static void main(String[] args) throws Exception {
		String outPath = "src/test/resources/Input/gpkg/BrokerGEOOneFlux.gpkg";

		// z (11 values) / deltaZ (first 11 of the original 12; the 12th was a -9999
		// sentinel never read by any FluxSplitMethod) read from GridLysRoot.nc
		...
		parameters.put(BrokerGeoInputsHandler.PARAM_REPRESENTATIVE_TS_MODEL, FluxSplitMethod.AVERAGE_WEIGHTED.name());
